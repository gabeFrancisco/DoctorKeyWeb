    ...
    <div>
      ...
      <div className='m-5 border-2 border-gray-300 border-dashed rounded-xl'>
        <div className='flex flex-row items-center justify-between align-baseline p-2'>
          <i className={`mx-10 mt-5 text-7xl text-gray-700 car-${key.manufactor.toLowerCase()}`}/>
        ...
        <div className='flex flex-row items-center justify-between m-5 text-gray-600'>
          ...
          <h3 className='text-lg'>Tipo: {key.keyType}</h3>
          <h3 className='text-lg'>Lâmina: {key.bladeType}</h3>
