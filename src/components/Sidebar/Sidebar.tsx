...
const Sidebar = () => {
  ...
  return (
    <aside
      id="sidebar"
      className={`overflow-x-hidden pt-12 md:pt-24 overflow-y-auto overflow-x-h flex flex-row-reverse lg:flex-col justify-evenly lg:justify-start bg-white ${
        toggle ? "" : "lg:w-1/5"
      } lg:h-screen sticky top-0 text-gray-500 lg:shadow border`}
    >
      {/* {!toggle ? (
      ...
      <ul className="flex flex-row justify-center items-center lg:flex-col lg:items-start">
        ...
        <div
          className="hidden lg:block px-5 my-10 cursor-pointer "
