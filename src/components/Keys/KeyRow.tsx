  ...
  return (
    ...
    >
      ...
      <td className="px-6 py-2">
        <motion.button whileHover={{scale: 1.1}}><FontAwesomeIcon icon={faPencil} className="p-2 border border-blue-400 text-blue-400 rounded-md mx-1 shadow" height={25}/></motion.button>
        <motion.button whileHover={{scale: 1.1}}><FontAwesomeIcon icon={faTrash} className="p-2 border border-red-400 text-red-400 rounded-md mx-1 shadow" height={25}/></motion.button>
      </td>
    </tr>
  );
};
